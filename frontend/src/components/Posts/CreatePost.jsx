...
import { fetchAllCategory } from "../../APIServices/category/categoryAPI";

export default function CreatePost() {
  //state for the wysiwg
  ...
  //Error
  const errMsg = postMutation?.error?.response?.data?.message;
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 m-4">
        ...
        {isError && <AlertMessage type="error" message={errMsg} />}
          ...
          <div>
            ...
            <Select
              ...
              options={data?.categories?.map((cat) => {
                return { value: cat._id, label: cat.categoryName };
              })}
              onChange={(option) => {
